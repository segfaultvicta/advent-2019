...
import { disp, debug } from "./util.js";
...
function init(c, rawinput) {
    ...
    var wires = rawinput.split("\n");
    c.input = { r: wires[0].split(","), g: wires[1].split(",") };
    debug(c, `INPUT: ${c.input}`);
    c.display = [];
}
...
async function step(c) {
    ...
    disp(c, "ADVENT OF CODE, BUT MAKE IT GAYER");
